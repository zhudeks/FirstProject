...
public class Main {
	public static void main(String[] args) {
		...
		*/
		...
		int[] input_array2 = {12, 5, 89, 100, 1022, 101, -1, 1, 0, 2, -5, 0, 9, 2, -1, 65, -100, -5, -1, 121, 3, -2};
		int[] input_array3 = {-4, -5};
		int[] input_array4 = {3, -2, -1, 4, 5, 2, 0, 0, 2, 1, 1, 2, 9, 0, 7, 2, -36, 4};
		...
		int[][] input_array9 = {{-104, 3, -3, 1},
								{0, 1, 3, 0},
								{8, -5, 12, 100},
								{3, 100, -9, 100}};

		Tasks.task028(input_array9);
		//First commit on dev
